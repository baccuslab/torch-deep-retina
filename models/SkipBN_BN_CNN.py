...
from models.torch_utils import GaussianNoise, ScaleShift, Flatten, Reshape, SkipConnectionBN

class SkipBNBNCNN(nn.Module):
    def __init__(self, output_units=5, noise=.05, bias=True, x_shape=(40,50,50)):
