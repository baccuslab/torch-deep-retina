...
class KineticsChannelModel(nn.Module):
    def __init__(self, bnorm=True, drop_p=0, scale_kinet=True, recur_seq_len=8, n_units=5, 
                 noise=.05, bias=True, linear_bias=True, chans=[8,8], bn_moment=.01, softplus=True, 
                 inference_exp=False, img_shape=(40,50,50), ksizes=(15,11), centers=None):
...
class KineticsChannelModel2(nn.Module):
    def __init__(self, drop_p=0, scale_kinet=True, recur_seq_len=8, n_units=5, 
        ...
        super(KineticsChannelModel2, self).__init__()
